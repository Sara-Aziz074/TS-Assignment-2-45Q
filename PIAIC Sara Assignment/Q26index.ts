...
10 points.*/
if (alien_color=="red"){console.log("You just earned 5 points for shooting the alien.")}
...
if (alien_color==="green"){console.log("Are you part of the game?")}

else {console.log("You just earned 5 points for shooting the alien.")}


//  this program runs the else block.
let alien_C:string="red"
if( (alien_C=="green")){console.log("You just earned 5 points for shooting the alien.")}

else {console.log("Yes! I'm...")}
