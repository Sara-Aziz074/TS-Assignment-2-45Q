...
function make_shirt(size:number,print:string):void
{ console.log(` A  white 'Female' long slves baggy  style T.shirt, its size ${size}
 and on its  SeaGreen text  print ${print}`)};
make_shirt(40,"Hi, pretty Girl!");