...
const Bus:string="Black"
 ...
 console.log("variable2=='10'? I predict True.",variable2<=10 )
  // Test 06
 console.log("variable2<='10' && variable2=='10'? I predict True."
 ,variable2<=10 && variable2==10 )


 //5 tests evaluate to False.


 const hourse:string="Black"
 ...
 console.log("vlu2=='19'? I predict False.",vlu2==19 )
  // Test 06
 console.log("vlu2<='1' && variable2=='15'? I predict False."
 ,vlu2<=1 && vlu2==15 )
