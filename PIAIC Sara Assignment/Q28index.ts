...
let person_Age=1
if(person_Age<2){console.log("This person is a baby.")}
else{console.log("This person is not a baby.")}     
...
/*• If the person is at least 2 years old but less than 4, print a message that the person
 ...
 else{console.log("This person is not  a toddler!")}
...
{console.log("This person is a kid.")}else{ "person is not a kid!"}
...
else{console.log("This  person is not an adult! ")}
/*• If the person is age 65 or older, print a message that the person is an elder.*/
let persoN_age=70
if (persoN_age>65 && persoN_age<72)
{console.log("This person is an elder. ")}
else{console.log("This person is not an elder! ")}