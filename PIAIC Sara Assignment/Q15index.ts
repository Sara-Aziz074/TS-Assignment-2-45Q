...
for(){}****/
const GuestList1:string[]=["Ayesha","Ammara","iram",]
GuestList1.forEach(
...
/*Modify your list, replacing the name of the guest who can’t make it
 ...
 /*• Print a second set of invitation messages, one for each person who is still in your list.*/ 
 GuestList1.forEach(
    function(name:string,index:number){ console.log(`${name}  Dear, I would invite you on a dinner friday 18-08-2023 at 7pm. `)
