...
//Exercise 16
const GuestList3:string[]=["Ayesha","Ammara","iram",]
GuestList3.forEach(
...
let absenttguest:string= "Ammara"
...
//can invite only two people for dinner.
 console.log
 ("Sorry guyes, I can invite only two people for dinner, becouse i did't found bigger table at  last moment ")
